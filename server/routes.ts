...
import { registerDiagnosticRoutes, registerTrackingRoutes, registerAuditRoutes, registerAdminRoutes, registerLegacySearchRoutes, registerDocsRoutes } from "./routes/index";
...
ONLY use IDs from the list. Never invent IDs.`
  ...
  // Legacy search routes - modularized (shopping, cinema, attractions, recommendations, events, restaurants, nightin, hintsandtips, activities)
